...
input_frame = tk.Frame(win, width=312, height=50, bd=0, highlightbackground="light blue", highlightcolor="sky blue", highlightthickness=20)
  
input_frame.pack(side = tk.TOP)
 
# Create a input field (Entry widget) inside the 'Frame'
  
input_field = tk.Entry(input_frame, font=('eurostyle', 22, 'bold'), textvariable = display_text, width=50, bg="#eee", bd=0, justify=tk.RIGHT)
...
btns_frame = tk.Frame(win, width=312, height=272.5, bg="white")
...
remove_btn = tk.Button(btns_frame, text = "<-", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: remove()).grid(row = 0, column = 3, padx = 1, pady = 1)
...
# 5th row
point_btn = tk.Button(btns_frame, text = ".", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: click_button_action(".")).grid(row = 4, column = 0, padx = 1, pady = 1)

btn_0 = tk.Button(btns_frame, text = "0", fg = "black", width = 10, height = 3, bd = 0, bg = "#fff", cursor = "hand2", command = lambda: click_button_action(0)).grid(row = 4, column = 1, columnspan = 1, padx = 1, pady = 1)

divide_btn = tk.Button(btns_frame, text = "/", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: click_button_action("/")).grid(row = 4, column = 2, padx = 1, pady = 1)
  
equals_btn = tk.Button(btns_frame, text = "=", fg = "white", width = 10, height = 3, bd = 0, bg = "#00CDCD", cursor = "hand2", command = lambda: equal_button_action()).grid(row = 4, column = 3, padx = 1, pady = 1)
